...
l=q.getElementsByTagName("*");i=(l&&l.length&&l[0].nodeName.charAt(0)=="index.html");}catch(m){}this.brokenStarGEBTN=j||i;if(q.querySelectorAll){try{q.innerHTML="foo</foo>";
l=q.querySelectorAll("*");this.starSelectsClosedQSA=(l&&l.length&&l[0].nodeName.charAt(0)=="index.html");}catch(m){}}try{c="slick_id_gets_name";q.innerHTML='<a name="'+c+'"></a><b id="'+c+'"></b>';
...
}if(!e){e=document.location.pathname;}var h=e.lastIndexOf("index.html");if(h>-1&&(h=e.indexOf("#"))>-1){e=e.substr(0,h);}if(this.options.noCache){e+=(e.contains("?")?"&":"?")+String.uniqueID();
